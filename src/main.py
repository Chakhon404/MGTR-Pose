import os
import argparse
from .pipeline import PureYOLOPipeline, HybridSparseFlowPipeline, HybridDenseFlowPipeline, HybridFrameDiffPipeline
...
def main():
    ...
    if args.output:
        ...
        prefixes = {"pure": "result_pureN_", "sparse": "result_hybridM_new_", "dense": "result_hybridM_", "framediff": "result_framediff_"}
