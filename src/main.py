...
from .pipeline import (
    PureYOLOPipeline, HybridSparseFlowPipeline, HybridDenseFlowPipeline, HybridFrameDiffPipeline,
...
def get_pipeline_class(pipeline_type):
    pipelines = {
        ...
        "framediff": HybridFrameDiffPipeline,
        "pure_mp": PureMediaPipePipeline,
        "sparse_mp": HybridMediaPipePipeline,
    }
...
def main():
    ...
    parser.add_argument("--pipeline", type=str, default="sparse", choices=["pure", "sparse", "dense", "framediff", "pure_mp", "sparse_mp"])
    ...
    # Set default model based on pipeline
    if args.model is None:
        if args.pipeline in ["pure_mp", "sparse_mp"]:
            args.model = "models/pose_landmarker_lite.task"
        else:
    ...
    if args.output:
        ...
        prefixes = {
            "pure": "result_pureN_",
            "sparse": "result_hybridM_new_",
            "dense": "result_hybridM_",
            "framediff": "result_framediff_",
            "pure_mp": "result_pureMP_",
            "sparse_mp": "result_hybridMP_"
        }
    ...
    if args.pipeline in ["pure", "pure_mp"]:
